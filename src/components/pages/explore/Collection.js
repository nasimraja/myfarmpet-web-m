...
import NFT_ABI from '../../../Confi2g/NFT_ABI.json';
...
const Collection = () => {
    ...
    const init = async () => {
        ...
        //  alert(rows);
        try{
        let _result = await fetch('https://address-marketplace.herokuapp.com/api/marketplace/lister/wizard/'+address);
...
useEffect(() => {
  ...
  const oloadmore = () => {
    ...
    details['0x1Fe414F05ee639F5c4c718544763BCECe739B4C5'] = {
      name: "Wolf Den",
      banner : Wolf
    } ; 
      ...
      <div className="main-bg">
        ...
        <div className="container">
          <div className="row">
              ...
              <h3 className="mb-3">{details[address] ? details[address].name : "Your "} Collection</h3>
                <small>Newly NFT listed might take one minute to show.</small>
